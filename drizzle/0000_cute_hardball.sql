...
CREATE TABLE "appointment"."connectors" (
	...
	"reminder_window_minutes" integer DEFAULT 10 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE INDEX "appointment_appointments_reminder_pending_idx" ON "appointment"."appointments" USING btree ("status","reminder_sent_at","start_time");--> statement-breakpoint
